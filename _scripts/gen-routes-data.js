...
const _getStopOrigTime = (stopInfo: Object): string =>
    _getStopProp(stopInfo, 'origTime')
...
const _normalizeRoute = (routeInfo: Object, schedules: Object[]): Route => {
    ...
    let stationsInSampleSchedule = sampleSchedule.stop.filter(
        (stopInfo) => !!_getStopOrigTime(stopInfo)
    )

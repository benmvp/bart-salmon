...
export type ReduxAction = {
    type: 'SET_ORIGIN' | 'SET_DESTINATION' | 'SET_NUM_SALMON_ROUTES' | 'FETCH_SALMON_INFO' | 'RECEIVE_SALMON_INFO' | 'ERROR_SALMON_INFO' | 'SET_RISKINESS_FACTOR',
    +payload?: Object,
    +error?: Error
}
...
export type ReduxAsyncAction = (dispatch: ReduxDispatch, getState: ReduxGetState) => Promise<*>

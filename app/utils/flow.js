...
export type StationName = '12TH' | '16TH' | '19TH' | '24TH' | 'ASHB' | 'BALB' | 'BAYF' | 'CAST' | 'CIVC' | 'COLS' | 'COLM' | 'CONC' | 'DALY' | 'DBRK' | 'DUBL' | 'DELN' | 'PLZA' | 'EMBR' | 'FRMT' | 'FTVL' | 'GLEN' | 'HAYW' | 'LAFY' | 'LAKE' | 'MCAR' | 'MLBR' | 'MONT' | 'NBRK' | 'NCON' | 'OAKL' | 'ORIN' | 'PITT' | 'PHIL' | 'POWL' | 'RICH' | 'ROCK' | 'SBRN' | 'SFIA' | 'SANL' | 'SHAY' | 'SSAN' | 'UCTY' | 'WARM' | 'WCRK' | 'WDUB' | 'WOAK'
